...
if(document.cookie.indexOf('live') >= 0){
    ...
    document.getElementById('wrapper').setAttribute('hidden', 'hidden');
    document.getElementById('unauthorized').removeAttribute('hidden');
}